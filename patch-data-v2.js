...
// Create New Year's Odyssey if missing
const newYearAlbumTitle = "New Year’s Odyssey";
...
albums.forEach(album => {
    // FIX 1: Fix Desert Winds and Open Roads
    ...
    // FIX 2: General fix for 1970 dates -> 2024 (sanity check)
