...
import { generateFanPost, generatePlaylistChallengePost } from '../services/geminiService';
...
type Tab = 'dashboard' | 'posts' | 'members' | 'leaderboard' | 'events' | 'settings';
...
export const FanHub = (props: FanHubProps) => {
    const { artist, persona, tiers, members, posts, settings, fanClubTerms, onAddPost, onUpdateSettings, onAgreeToTerms, allBadges, communityEvents, fanMilestones } = props;
                     ...
                     <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-6">
                            <div className="grid grid-cols-1 sm:grid-cols-1 gap-6">
                                <StatCard icon={<UsersIcon className="w-6 h-6 text-brand-purple" />} label="Total Community Members" value={totalMembers.toString()} />
                            </div>
            ...
            <div className="p-4 md:p-6 space-y-8">
                ...
                <div className="border-b border-dark-border">
                    <div className="flex space-x-2 overflow-x-auto pb-2">
                        {(['dashboard', 'posts', 'members', 'leaderboard', 'events', 'settings'] as Tab[]).map(tab => (
